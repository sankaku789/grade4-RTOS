...
+ 次に示すプログラムを作成し、作成したプログラムの内容を考察せよ \
...
+ 次に示すプログラムを作成し、作成したプログラムの内容、task1 と task2 の動作を考察せよ \
...
+ 課題プログラム [ex31.c]、[ex41.c]、[ex42.c] の何れかを、セマフォによりタスク間の同期を行うプログラムに変更し、変更した内容を考察せよ \
...
+ 課題プログラム [ex31.c]、[ex41.c]、[ex42.c] の何れかを、データキュー（パイプ）によりタスク間の同期を行うプログラムに変更し、変更した内容を考察せよ \
